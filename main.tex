...
% modification of an earlier template.
%
% This template is a combination of the guidelines of the Polytechnique Institute of Paris 
% and the template made by Victor Brena: https://frama.link/thesis_template
%
% IPP guidelines:
%
% https://jct.telecom-paris.fr/templates/
%
...
% Support for research question definition and cross referencing using cleveref.
...
\clubpenalty=1000
%
% New command definitions for the thesis
%
%% CUSTOM
...
\newcommand{\initial}[1]{%
	\lettrine[lines=3,lhang=0.33,nindent=0em]{
		\color{black}
     		{\textsc{#1}}}{}}
%
% Theorem styles used in the thesis
%
...
%
%
\graphicspath{{images/}{pdfs/}{figs/}{svgs/}{odgs/}{figures/}}
...
\pagenumbering{roman}
%
% Front cover source: models/LaTeX/1ere.tex (compiled to models/LaTeX/1ere.pdf)
\includepdf[pages=1]{models/LaTeX/1ere.pdf}
...
\bibliography{this}
\clearemptydoublepage
% Back cover source: models/LaTeX/4eme.tex (compiled to models/LaTeX/4eme.pdf)
\includepdf[pages=1]{models/LaTeX/4eme.pdf}
%
% Add index
%\printindex
%   
